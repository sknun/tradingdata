...
import "github.com/sknun/tradingdata/internal/api"
...
*/
func (c *Client) HistoryKline(code, kline_timestamp_end, count, resolution any) (res *api.KlineResponse, err error) {
...
resolution 颗度 1m 5m 15m 30m 1h 4h D W M
*/
func (c *Client) HistoryKlineBatch(codes, kline_timestamp_end, count, resolution any) (res *[]api.KlineBatchResponse, err error) {
