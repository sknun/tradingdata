...
*/
func (c *Client) HistoryKline(symbol, kline_timestamp_end, count, resolution any) (res *klinestruct.KlineResponse, err error) {
...
resolution 颗度 1m 5m 15m 30m 1h 4h D W M
*/
func (c *Client) HistoryKlineBatch(symbols, kline_timestamp_end, count, resolution any) (res *[]klinestruct.KlineBatchResponse, err error) {
